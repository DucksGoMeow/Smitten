...
if (timerDone == 0 && obj_levelTimer.tSec == 0 && obj_levelTimer.tMin == 0 && obj_levelTimer.tMil == 0){ //toggle pause (whatever trigger youd like)
	if (!pausegame) { //pause now
		...
		instance_create_layer(544, 576, "Instances", obj_resetLevel);
		instance_create_layer(544, 448, "Instances", obj_nextLevel);
		instance_create_layer(544, 448, "Instances", obj_levelTimer);
