if (!obj_monsterTimer.noMonster && !obj_monsterTimer.noLeftMonster && obj_monsterTimer.noRightMonster){
	...
	switch (obj_leftMonsterSprite.randNumType){
		case 1:
			...
			break;
		case 2:
			monsterComingSpr = spr_wolfspiderIdleRight;
		...
		case 21:
			...
			case 41:
				if (!patternUp){
					...
					draw_sprite(spr_down, 0, 350.5, 197);
					draw_sprite(spr_left, 0, 247.5, 197);
					draw_sprite(spr_right, 0, 144.5, 197);
				}
			...
			case 50:
				if (!patternDown){
					...
					draw_sprite(spr_left, 0, 350.5, 197);
					draw_sprite(spr_right, 0, 247.5, 197);
					draw_sprite(spr_up, 0, 144.5, 197);
				}
		...
		case 69:
			...
			case 92:
				if (!patternUp){
					...
					draw_sprite(spr_left, 0, 350.5, 197);
					draw_sprite(spr_right, 0, 247.5, 197);
					draw_sprite(spr_downReversed, 0, 144.5, 197);
				}
			...
			case 97:
				if (!patternDown){
					...
					draw_sprite(spr_left, 0, 350.5, 197);
					draw_sprite(spr_upReversed, 0, 247.5, 197);
					draw_sprite(spr_rightReversed, 0, 144.5, 197);
				}
			...
			case 98:
				if (!patternDownReversed){
					...
					draw_sprite(spr_left, 0, 350.5, 197);
					draw_sprite(spr_right, 0, 247.5, 197);
					draw_sprite(spr_upReversed, 0, 144.5, 197);
				}
			...
			case 107:
				if (!patternRightReversed){
					...
					draw_sprite(spr_upReversed, 0, 350.5, 197);
					draw_sprite(spr_downReversed, 0, 247.5, 197);
					draw_sprite(spr_leftReversed, 0, 144.5, 197);
				}
