if (!obj_monsterTimer.noMonster && !obj_monsterTimer.noRightMonster && obj_monsterTimer.noLeftMonster){
	...
	if (tSec >= 6 && tSec <= 15){
		draw_sprite(spr_arrowBox, 0, 960, 155);
		#region Draw Arrow Pattern
		switch (randNumArrow){
			#region 1 Arrow
			case 1:
				if (!patternUp){
					draw_sprite(spr_up, 0, 960, 160);
				}
				break;
				
			case 2:
				if (!patternDown){
					draw_sprite(spr_down, 0, 960, 160);
				}
				break;
				
			case 3:
				if (!patternLeft){
					draw_sprite(spr_left, 0, 960, 160);
				}
				break;
				
			case 4:
				if (!patternRight){
					draw_sprite(spr_right, 0, 960, 160);
				}
				break;
			...
			case 5:
				if (!patternUp){
					draw_sprite(spr_up, 0, 960, 160);
					draw_sprite(spr_down, 0, 1056, 160);
				}
			...
			case 6:
				if (!patternUp){
					draw_sprite(spr_up, 0, 960, 160);
					draw_sprite(spr_left, 0, 1056, 160);
				}
			...
			case 7:
				if (!patternUp){
					draw_sprite(spr_up, 0, 960, 160);
					draw_sprite(spr_right, 0, 1056, 160);
				}
			...
			case 17:
				if (!patternUp){
					draw_sprite(spr_up, 0, 960, 160);
					draw_sprite(spr_down, 0, 1056, 160);
					draw_sprite(spr_left, 0, 1152, 160);
				}
			...
			case 18:
				if (!patternUp){
					draw_sprite(spr_up, 0, 960, 160);
					draw_sprite(spr_down, 0, 1056, 160);
					draw_sprite(spr_right, 0, 1152, 160);
				}
			...
			case 19:
				if (!patternUp){
					draw_sprite(spr_up, 0, 960, 160);
					draw_sprite(spr_left, 0, 1056, 160);
					draw_sprite(spr_down, 0, 1152, 160);
				}
		...
		case 21:
			...
			case 41:
				if (!patternUp){
					...
					draw_sprite(spr_down, 0, 1056, 160);
					draw_sprite(spr_left, 0, 1152, 160);
					draw_sprite(spr_right, 0, 1248, 160);
				}
			...
			case 42:
				if (!patternUp){
					...
					draw_sprite(spr_down, 0, 1056, 160);
					draw_sprite(spr_right, 0, 1152, 160);
					draw_sprite(spr_left, 0, 1248, 160);
				}
			...
			case 44:
				if (!patternUp){
					...
					draw_sprite(spr_left, 0, 1056, 160);
					draw_sprite(spr_right, 0, 1152, 160);
					draw_sprite(spr_down, 0, 1248, 160);
				}
