if (!obj_monsterTimer.noMonster && !obj_monsterTimer.noRightMonster && obj_monsterTimer.noLeftMonster){
	...
	#region Draw Arrow Pattern
		switch (randNumArrow){
			...
			case 1:
				if (!patternUp){
					draw_sprite(spr_up, 0, 942, 153);
				}
				break;
				
			case 2:
				if (!patternDown){
					draw_sprite(spr_down, 0, 942, 153);
				}
				break;
				
			case 3:
				if (!patternLeft){
					draw_sprite(spr_left, 0, 942, 153);
				}
				break;
				
			case 4:
				if (!patternRight){
					draw_sprite(spr_right, 0, 942, 153);
				}
				break;
			...
			case 5:
				if (!patternUp){
					draw_sprite(spr_up, 0, 942, 153);
					draw_sprite(spr_down, 0, 1006, 153);
				}
			...
			case 6:
				if (!patternUp){
					draw_sprite(spr_up, 0, 942, 153);
					draw_sprite(spr_left, 0, 1006, 153);
				}
			...
			case 7:
				if (!patternUp){
					draw_sprite(spr_up, 0, 942, 153);
					draw_sprite(spr_right, 0, 1006, 153);
				}
			...
			case 17:
				if (!patternUp){
					draw_sprite(spr_up, 0, 942, 153);
					draw_sprite(spr_down, 0, 1006, 153);
					draw_sprite(spr_left, 0, 1070, 153);
				}
			...
			case 18:
				if (!patternUp){
					draw_sprite(spr_up, 0, 942, 153);
					draw_sprite(spr_down, 0, 1006, 153);
					draw_sprite(spr_right, 0, 1070, 153);
				}
			...
			case 19:
				if (!patternUp){
					draw_sprite(spr_up, 0, 942, 153);
					draw_sprite(spr_left, 0, 1006, 153);
					draw_sprite(spr_down, 0, 1070, 153);
				}
		...
		case 21:
			...
			case 41:
				if (!patternUp){
					...
					draw_sprite(spr_down, 0, 1006, 153);
					draw_sprite(spr_left, 0, 1070, 153);
					draw_sprite(spr_right, 0, 1134, 153);
				}
			...
			case 42:
				if (!patternUp){
					...
					draw_sprite(spr_down, 0, 1006, 153);
					draw_sprite(spr_right, 0, 1070, 153);
					draw_sprite(spr_left, 0, 1134, 153);
				}
			...
			case 44:
				if (!patternUp){
					...
					draw_sprite(spr_left, 0, 1006, 153);
					draw_sprite(spr_right, 0, 1070, 153);
					draw_sprite(spr_down, 0, 1134, 153);
				}
