...
if (room == rm_level1Battle || room == rm_level2Battle || room == rm_level3Battle || room == rm_level4Battle || room == rm_level5Battle  || room == rm_level5Battle2){
	if(dev0Up){ 
		if (g == "UP"){
			upAnimation(); 
...
if (tSec == 0 && tMil == 0){
	if (room == rm_tutorial || room == rm_level2Start || room == rm_level3Start || room == rm_level4Start || room == rm_level5Start || room == rm_level5Start2 || room == rm_level5Battle || room == rm_level5Tutorial){
