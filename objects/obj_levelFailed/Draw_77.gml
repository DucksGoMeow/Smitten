...
if (obj_monsterTimer.noMonster && obj_playerHealth.playerHealth == 0){ //toggle pause (whatever trigger youd like)
	if (!pausegame) { //pause now
		...
		instance_activate_object(obj_levelCleared);
		...
		instance_create_layer(533, 400.9, "Pause_Menu", obj_failedResetLevel);
		instance_create_layer(533, 516.4, "Pause_Menu", obj_failedMainMenu);
