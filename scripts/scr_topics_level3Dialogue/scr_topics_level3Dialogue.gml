...
topics[$ "L3_Intro"] = [
	...
	TEXTWAUDIO("My dearest Hunter, fashionably late", snd_count),
	TEXTWAUDIO("I see. Welcome to the amusement park!", snd_count),
	...
	CUSTOMTEXTWAUDIO("", function() {room_goto(rm_level3Battle)}, snd_hunter),
...
topics[$ "L3_Date"] = [
	...
	SPEAKER("Hunter", spr_dPHunter_Neutral, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("Heh, smooth.", snd_hunter),
	TEXTWAUDIO("(Calm down, calm down, calm down.)", snd_hunter),
	
	CUSTOMTEXTWAUDIO("By the way...", function() {obj_textbox.restartDialogue();}, snd_count),
	CHOICE("Sorry for squeezing so hard and screaming in terror",
		OPTION("Grip elsewhere.", "I'd like to feel that grip elsewhere."),
		OPTION("Me too", "Me too, that was terrifying."),
		OPTION("Like a girl.", "You screamed like a little girl.")),
	...
	CUSTOMTEXTWAUDIO("I know! It scared the living daylights out of me!", function() {obj_textbox.restartDialogue();}, snd_count),
	TEXTWAUDIO(" ...Though that'd be kinda backwards for me, huh?", snd_count),
	...
	SPEAKER("Hunter", spr_dPHunter_Neutral, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("(Oh no, Scarab above...!)", snd_hunter),
	...
	CHOICE("...Am I wrong?",
		OPTION("Bugs have respect", "Bugs respect any member of the monster hunters."),
		OPTION("I wouldn't know.", "Do they? I'm just doing my job, I wouldn't know."),
		OPTION("Never thought about it", "Huh... I never thought about it like that.")),
	...
	TEXTWAUDIO("I earned my mandibles, my rank, just like anybody else.", snd_hunter),
	TEXTWAUDIO("I keep away the monsters who treat us like prey.", snd_hunter),
	...
	CHOICE("Which is...",
		OPTION("Really cool dude.", "Honestly a really cool dude."),
		OPTION("Lower my guard", "Someone I can leave my guard down with."),
	...
	CUSTOMTEXTWAUDIO("Yeah... I... I feel the same way! Um... would you wanna go out some other time?", function() {instance_create_layer(0, 0, "Instances", obj_level3HeartEvent)}, snd_hunter),
	];
	...
	CUSTOMTEXTWAUDIO("(...Crap.)", function() {obj_level3HeartEvent.doneDate = true}, snd_hunter),
	...
	SPEAKER("Hunter", spr_dPHunter_Neutral, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("Well, we might've brought too much attention to ourselves at the park,", snd_hunter),
	TEXTWAUDIO("so it'd probably be smart to go to more secluded areas for our next date.", snd_hunter),
	...
	CUSTOMTEXTWAUDIO("(I HAVE to lock in next time. For him!)", function() {obj_level3HeartEvent.doneDate = true}, snd_hunter),
	...
	SPEAKER("Hunter", spr_dPHunter_Neutral, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("Well, we might've brought too much attention to ourselves at the park...", snd_hunter),
	TEXTWAUDIO("So it'd probably be smart to go to more secluded areas for now. Somewhere in town.", snd_hunter),
	...
	SPEAKER("Hunter", spr_dPHunter_Neutral, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("I have, and of course I can.", snd_hunter),
	TEXTWAUDIO("But my gut's telling me that we have to.", snd_hunter),
	TEXTWAUDIO("And... I... um...", snd_hunter),
	
	CUSTOMTEXTWAUDIO("You, um...?", function() {obj_textbox.restartDialogue();}, snd_count),
	
	SPEAKER("Hunter", spr_dPHunter_Neutral, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("I can't risk you getting hurt.", snd_hunter),
	TEXTWAUDIO("Me being 'unbeatable' aside.", snd_hunter),
	...
	TEXTWAUDIO("I've always disliked the thought of you getting hurt", snd_hunter),
	TEXTWAUDIO("Of course, but now that I know more about you and your family, I...", snd_hunter),
	TEXTWAUDIO("I can't let your wretched mother get a hold of you.", snd_hunter),
	TEXTWAUDIO("Neither you, nor the bugs caught in the crossfire.", snd_hunter),
	...
	CUSTOMTEXTWAUDIO("Ahahaha! I always had a feeling you were daring, but to call the oh-so powerful Countess a wretch!?", function() {obj_textbox.restartDialogue();}, snd_count),
	TEXTWAUDIO("HAH! You might have more screws loose than I thought!", snd_count),
	
	SPEAKER("Hunter", spr_dPHunter_Neutral, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("(Haha. Ha ha ha ha ha. Ha? Wha? Wha?)", snd_hunter),
	TEXTWAUDIO("(You're insane, Hunter. He called you insane. You screwed up big time.)", snd_hunter),
	TEXTWAUDIO("(You screwed up big time. He'll never want to see you again after this. Why did you-)", snd_hunter),
	...
	CUSTOMTEXTWAUDIO("Nonono, I should be thanking YOU, Hunter!", function() {obj_textbox.restartDialogue();}, snd_count),
	TEXTWAUDIO("I genuinely don't remember feeling this... free before, y'know? Not even once...", snd_count),
	TEXTWAUDIO("I get to be myself around you. And you, open up.", snd_count),
	TEXTWAUDIO("And it's the most wonderful feeling in the world.", snd_count),
	
	SPEAKER("Hunter", spr_dPHunter_Neutral, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("(Ah...)", snd_hunter),
	TEXTWAUDIO("I feel the same way.", snd_hunter),
	TEXTWAUDIO("You always manage to make me feel at ease, even when I'm on duty. And... I like seeing you happy.", snd_hunter),
	TEXTWAUDIO("And... I like seeing you happy.", snd_hunter),
	...
	CUSTOMTEXTWAUDIO("...Hehe.", function() {obj_level3HeartEvent.doneDate = true},snd_hunter),
