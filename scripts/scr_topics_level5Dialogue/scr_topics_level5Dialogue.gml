function scr_topics_level5Dialogue(topics){
	...
	#region Level 5 Date
	topics[$ "L5_Date"] = [
	CUSTOMTEXTWAUDIO("Hunter! She’s down!", function() {obj_textbox.restartDialogue();}, snd_count),
	
	SPEAKER("Hunter", spr_dialoguePortraitHunter, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("*Cough* ....Yeah… seems like the rest of the monsters dipped.", snd_hunter),
	
	CUSTOMTEXTWAUDIO("Hunter! Hunter!", function() {obj_textbox.restartDialogue();}, snd_count),
	
	SPEAKER("Hunter", spr_dialoguePortraitHunter, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("...Huh?", snd_hunter),
	
	CUSTOMTEXTWAUDIO("My sugar cube, my cheese slice– my– oh– screw it– are you okay oh my Scarab–", function() {obj_textbox.restartDialogue();}, snd_count),
	
	SPEAKER("Hunter", spr_dialoguePortraitHunter, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("Snrk…", snd_hunter),
	
	CUSTOMTEXTWAUDIO("Huh…? What’s so funny?", function() {obj_textbox.restartDialogue();}, snd_count),
	
	SPEAKER("Hunter", spr_dialoguePortraitHunter, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("..You’re fussing. It’s adorable.", snd_hunter),
	
	CUSTOMTEXTWAUDIO("Oh quit it! I thought you were hit! You look so exhausted… so drained… I can’t help it.", function() {obj_textbox.restartDialogue();}, snd_count),
	
	CUSTOMTEXTWAUDIO("My dear, you need to rest.", function() {obj_textbox.restartDialogue();}, snd_count),
	
	SPEAKER("Hunter", spr_dialoguePortraitHunter, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("Yeah… when we leave. Right now… I just wanna look at you.", snd_hunter),
	
	CUSTOMTEXTWAUDIO("You know… I am a little irked that you hadn’t brought her up sooner. You should know by this point–", function() {obj_textbox.restartDialogue();}, snd_count),
	...
	CUSTOMTEXTWAUDIO("Scarab above… the heavens could rain upon me as many blessings as I pray for, and yet they could never match–", function() {obj_textbox.restartDialogue();}, snd_count),
	
	CUSTOMTEXTWAUDIO("Oh– whatever, man, you get the point! Yes! Absolutely, yes! I would love to!?", function() {obj_textbox.restartDialogue();}, snd_count),
	
	SPEAKER("Hunter", spr_dialoguePortraitHunter, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("Oh, thank god… I was terrified you’d still say no for some reason.", snd_hunter),
	
	CUSTOMTEXTWAUDIO("Nonsense. You don’t have to fear anything with me, anymore… I trust you.", function() {obj_textbox.restartDialogue();}, snd_count),
	
	CUSTOMTEXTWAUDIO("I love you, my beloved Hunter.", function() {obj_textbox.restartDialogue();}, snd_count),
	
	SPEAKER("Hunter", spr_dialoguePortraitHunter, PORTRAIT_SIDE.LEFT),
	TEXTWAUDIO("...I love you, Count. More than I can say.", snd_hunter),
